      ...
      <QueryClientWrapper>
        <BrowserRouter>
          <ThemeProvider defaultTheme="dark" storageKey="site-theme">
            <Toaster />
            <div className="text-sm leading-7 flex flex-col gap-y-8 min-h-svh w-svw items-center pb-5 px-4 sm:px-4 md:px-8 dark:selection:bg-yellow-700 selection:bg-gray-300 relative">
              <Navbar />
